...
## [0.95.0](https://github.com/tiborsimko/reana-workflow-engine-yadage/compare/0.9.5...0.95.0) (2026-09-22)
...
* **python:** pin setuptools below 81 ([#296](https://github.com/tiborsimko/reana-workflow-engine-yadage/issues/296)) ([06acfb0](https://github.com/tiborsimko/reana-workflow-engine-yadage/commit/06acfb0ebd35571c8c239c92c007e54548e068ea))
...
* **externalbackend:** pass HTCondor CPU/memory/disk/requirements ([#303](https://github.com/tiborsimko/reana-workflow-engine-yadage/issues/303)) ([4e35a5e](https://github.com/tiborsimko/reana-workflow-engine-yadage/commit/4e35a5efbfe145c176516d1765b21c9db9f4e44a))
...
* **config:** use glob for egg-info in flake8 exclude ([#284](https://github.com/tiborsimko/reana-workflow-engine-yadage/issues/284)) ([51794e4](https://github.com/tiborsimko/reana-workflow-engine-yadage/commit/51794e4c467e2d3dcd57375ecac96f37d5de57c0))
* **externalbackend:** handle rejection without noisy traceback ([#301](https://github.com/tiborsimko/reana-workflow-engine-yadage/issues/301)) ([f283d95](https://github.com/tiborsimko/reana-workflow-engine-yadage/commit/f283d95a4681dbc692d9ba2ce69becd904a09bcd)), closes [#300](https://github.com/tiborsimko/reana-workflow-engine-yadage/issues/300)
* **git:** update .gitignore to exclude modules directory ([#302](https://github.com/tiborsimko/reana-workflow-engine-yadage/issues/302)) ([7dff82d](https://github.com/tiborsimko/reana-workflow-engine-yadage/commit/7dff82df0bfad3754ae8113dc681e40c6ce2ed4c))
...
* **pytest:** drop pytest-reana and use pytest directly ([#299](https://github.com/tiborsimko/reana-workflow-engine-yadage/issues/299)) ([5e735c1](https://github.com/tiborsimko/reana-workflow-engine-yadage/commit/5e735c1139ebec239b3271caeb6ddd60435fe95d))


### Code style

* **python:** adapt code base to the new black version ([#296](https://github.com/tiborsimko/reana-workflow-engine-yadage/issues/296)) ([cdfc12c](https://github.com/tiborsimko/reana-workflow-engine-yadage/commit/cdfc12c51083e160d5ad493012440296f4f45b8a))
...
* **markdownlint:** less permissive global configuration ([#297](https://github.com/tiborsimko/reana-workflow-engine-yadage/issues/297)) ([58687fd](https://github.com/tiborsimko/reana-workflow-engine-yadage/commit/58687fd6eaf3562aabf35c4e8acba4ac749be4fe))
...
* **release-please:** upgrade action to v5 ([#309](https://github.com/tiborsimko/reana-workflow-engine-yadage/issues/309)) ([0684337](https://github.com/tiborsimko/reana-workflow-engine-yadage/commit/06843374f75243e93c845f7fb40da2983f891c96))
...
* **run-tests:** add usage help and refactor options ([#297](https://github.com/tiborsimko/reana-workflow-engine-yadage/issues/297)) ([3161193](https://github.com/tiborsimko/reana-workflow-engine-yadage/commit/316119311767d25b675d990661839113fa3e78c4))
